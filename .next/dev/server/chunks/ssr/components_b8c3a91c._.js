...
function Reasoning({ children, isStreaming = false }) {
...
function ReasoningTrigger({ children }) {
...
function UserMessage({ content, imageUrl, index }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "rounded-3xl px-5 py-2 bg-[#ededed] dark:bg-[#2a2a2a] text-stone-900 dark:text-stone-100 font-light",
        children: [
...
const code = `{messages.map((message, index) => (
  ...
  >
    {message.role === "user" ? (
      // USER MESSAGE BUBBLE
      <div className="rounded-3xl px-5 py-2 bg-[#ededed] dark:bg-[#2a2a2a] text-stone-900 dark:text-stone-100 font-light">
        {message.imageUrl && (
          <img 
      ...
      <div className="w-full min-w-0 flex-1">
        ...
        <Markdown className="prose dark:prose-invert max-w-none text-base font-medium text-black dark:text-white">
          {message.content}
        </Markdown>
      </div>
    )}
...
//# sourceMappingURL=components_b8c3a91c._.js.map